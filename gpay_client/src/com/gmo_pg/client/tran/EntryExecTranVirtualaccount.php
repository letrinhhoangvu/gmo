<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranVirtualaccountOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranVirtualaccount.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranVirtualaccount.php';
/**
