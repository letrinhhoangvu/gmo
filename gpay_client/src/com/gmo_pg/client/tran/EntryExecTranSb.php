<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranSbOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranSb.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranSb.php';
/**
