<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranSbContinuanceOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranSbContinuance.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranSbContinuance.php';
/**
