<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranMcpOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranMcp.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranMcp.php';
/**
