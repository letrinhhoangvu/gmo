<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranUnionpayOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranUnionpay.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranUnionpay.php';
/**
