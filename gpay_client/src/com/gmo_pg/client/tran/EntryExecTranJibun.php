<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranJibunOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranJibun.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranJibun.php';
/**
