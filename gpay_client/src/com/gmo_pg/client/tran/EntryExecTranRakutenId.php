<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranRakutenIdOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranRakutenId.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranRakutenId.php';
/**
