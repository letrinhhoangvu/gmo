<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranRecruitOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranRecruit.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranRecruit.php';
/**
