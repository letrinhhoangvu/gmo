<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranNetcashOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranNetcash.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranNetcash.php';
/**
