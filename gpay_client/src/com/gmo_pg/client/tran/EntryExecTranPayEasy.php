<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranPayEasyOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/TdVerifyInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/AcsParam.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranPayEasy.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranPayEasy.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/TdVerify.php';
