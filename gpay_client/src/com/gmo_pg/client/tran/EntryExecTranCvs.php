<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranCvsOutput.php';
...
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranCvs.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranCvs.php';
