<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranLinepayOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranLinepay.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranLinepay.php';
/**
