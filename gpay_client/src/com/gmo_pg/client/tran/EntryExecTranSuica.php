<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranSuicaOutput.php';
...
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranSuica.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranSuica.php';
