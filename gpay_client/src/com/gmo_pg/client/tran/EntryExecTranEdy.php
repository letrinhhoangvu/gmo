<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranEdyOutput.php';
...
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranEdy.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranEdy.php';
