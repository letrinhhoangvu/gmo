<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranDocomoOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranDocomo.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranDocomo.php';
/**
