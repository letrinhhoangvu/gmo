<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranOutput.php';
...
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTran.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTran.php';
