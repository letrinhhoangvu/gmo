<?php
require_once ROOT_GMO.'com/gmo_pg/client/common/Log.php';
require_once ROOT_GMO.'com/gmo_pg/client/common/ParamParser.php';
require_once ROOT_GMO.'com/gmo_pg/client/common/IgnoreCaseMap.php';
require_once ROOT_GMO.'com/gmo_pg/client/common/GPayException.php';
require_once ROOT_GMO.'com/gmo_pg/client/common/ConnectUrlMap.php';
/**
 * @abstract
 * <b>API 基底クラス</b>
 *
