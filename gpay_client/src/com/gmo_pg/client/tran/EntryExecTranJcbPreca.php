<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranJcbPrecaOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranJcbPreca.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranJcbPreca.php';
/**
