<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryExecTranPaypalOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/EntryTranPaypal.php';
require_once ROOT_GMO.'com/gmo_pg/client/tran/ExecTranPaypal.php';
