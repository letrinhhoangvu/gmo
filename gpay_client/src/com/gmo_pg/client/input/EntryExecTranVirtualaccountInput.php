<?php
require_once ROOT_GMO.'com/gmo_pg/client/input/EntryTranVirtualaccountInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/ExecTranVirtualaccountInput.php';
/**
