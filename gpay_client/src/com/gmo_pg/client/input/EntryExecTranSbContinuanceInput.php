<?php
require_once ROOT_GMO.'com/gmo_pg/client/input/EntryTranSbContinuanceInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/ExecTranSbContinuanceInput.php';
/**
