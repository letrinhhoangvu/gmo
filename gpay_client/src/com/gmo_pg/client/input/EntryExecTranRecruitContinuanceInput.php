<?php
require_once ROOT_GMO.'com/gmo_pg/client/input/EntryTranRecruitContinuanceInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/ExecTranRecruitContinuanceInput.php';
/**
