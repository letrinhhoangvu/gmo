<?php
require_once ROOT_GMO.'com/gmo_pg/client/input/EntryTranAuContinuanceInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/ExecTranAuContinuanceInput.php';
/**
