<?php
require_once ROOT_GMO.'com/gmo_pg/client/input/EntryTranDocomoContinuanceInput.php';
require_once ROOT_GMO.'com/gmo_pg/client/input/ExecTranDocomoContinuanceInput.php';
/**
