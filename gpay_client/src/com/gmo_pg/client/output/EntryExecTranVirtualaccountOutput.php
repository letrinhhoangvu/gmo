<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryTranVirtualaccountOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/output/ExecTranVirtualaccountOutput.php';
/**
