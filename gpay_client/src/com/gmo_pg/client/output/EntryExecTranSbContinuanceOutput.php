<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryTranSbContinuanceOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/output/ExecTranSbContinuanceOutput.php';
/**
