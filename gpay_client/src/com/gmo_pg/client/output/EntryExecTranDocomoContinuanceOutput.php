<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryTranDocomoContinuanceOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/output/ExecTranDocomoContinuanceOutput.php';
/**
