<?php
require_once ROOT_GMO.'com/gmo_pg/client/output/EntryTranRecruitContinuanceOutput.php';
require_once ROOT_GMO.'com/gmo_pg/client/output/ExecTranRecruitContinuanceOutput.php';
/**
