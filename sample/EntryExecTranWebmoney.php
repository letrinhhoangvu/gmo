...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranWebmoneyInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranWebmoneyInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranWebmoneyInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranWebmoney.php');
