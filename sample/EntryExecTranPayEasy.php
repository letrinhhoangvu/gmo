...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranPayEasyInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranPayEasyInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranPayEasyInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranPayEasy.php');
