...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranNetcashInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranNetcashInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranNetcashInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranNetcash.php');
