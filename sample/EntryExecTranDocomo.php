...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranDocomoInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranDocomoInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranDocomoInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranDocomo.php');
