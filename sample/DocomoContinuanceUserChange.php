...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/DocomoContinuanceUserChangeInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/DocomoContinuanceUserChange.php');
