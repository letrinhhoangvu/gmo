...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/RegisterRecurringAccounttransInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/RegisterRecurringAccounttrans.php');
