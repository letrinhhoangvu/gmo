...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranUnionpayInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranUnionpayInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranUnionpayInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranUnionpay.php');
