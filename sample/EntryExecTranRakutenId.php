...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranRakutenIdInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranRakutenIdInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranRakutenIdInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranRakutenId.php');
