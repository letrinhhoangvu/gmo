...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/DocomoContinuanceCancelReturnInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/DocomoContinuanceCancelReturn.php');
