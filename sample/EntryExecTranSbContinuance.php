...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranSbContinuanceInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranSbContinuanceInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranSbContinuanceInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranSbContinuance.php');
