...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranSuicaInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranSuicaInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranSuicaInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranSuica.php');
