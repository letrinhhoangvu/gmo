...
if( isset( $_POST['submit'] ) ){
	require_once( ROOT.'com/gmo_pg/client/input/EntryTranJibunInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/ExecTranJibunInput.php');
	require_once( ROOT.'com/gmo_pg/client/input/EntryExecTranJibunInput.php');
	require_once( ROOT.'com/gmo_pg/client/tran/EntryExecTranJibun.php');
