...
<head>
	...
	<title>[RecruitContinuanceChargeCancel]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>リクルートかんたん支払い継続課金課金データ取消/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">継続課金年月(ContinuanceMonth)</th>
				<td><input name="ContinuanceMonth" type="text" size="27" tabindex="16" /></td>
			</tr>
