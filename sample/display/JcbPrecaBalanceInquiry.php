...
<head>
	...
	<title>[JcbPrecaBalanceInquiry]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>JCBプリカ残高照会/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="ApprovalNo" type="text" size="27" tabindex="14" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				<tr>
					<th scope="row">取引ID(CardNo)</th>
					<td><?php echo $output->getCardNo() ?></td>
				</tr>
				<tr>
					<th scope="row">取引パスワード(Balance)</th>
					<td><?php echo $output->getBalance() ?></td>
				</tr>
				<tr>
