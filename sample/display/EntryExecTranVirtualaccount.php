...
<div id="header">
	<h1>銀行振込(バーチャル口座)登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="TradeDays" type="text" size="10" tabindex="18" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">取引事由(TradeReason)</th>
				<td><input name="TradeReason" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">振込依頼者氏名(TradeClientName)</th>
				<td><input name="TradeClientName" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">振込依頼者メールアドレス(TradeClientMailaddress)</th>
				<td><input name="TradeClientMailaddress" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
