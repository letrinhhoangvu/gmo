...
<head>
	...
	<title>[RecruitUpdateAuth]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>リクルートかんたん支払いオーソリ期限延長/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">オーソリ期限延長実施日(RcUpdateAuthDay)</th>
