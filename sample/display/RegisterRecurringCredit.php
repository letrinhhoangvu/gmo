...
<head>
	...
	<title>[RegisterRecurringCredit]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>自動売上自動売上登録/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">対象種別(RegistType)</th>
				<td><input name="RegistType" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
				<th scope="row">サイトID(SiteID)</th>
				<td><input name="SiteID" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">サイトパスワード(SitePass)</th>
				<td><input name="SitePass" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
				<th scope="row">会員ID(MemberID)</th>
				<td><input name="MemberID" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">カード番号(CardNo)</th>
				<td><input name="CardNo" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">カード有効期限(Expire)</th>
				<td><input name="Expire" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">元取引オーダーID(SrcOrderID)</th>
				<td><input name="SrcOrderID" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">課金日(ChargeDay)</th>
				<td><input name="ChargeDay" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">課金月(ChargeMonth)</th>
				<td><input name="ChargeMonth" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">課金開始日(ChargeStartDate)</th>
				<td><input name="ChargeStartDate" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">課金停止日(ChargeStopDate)</th>
				<td><input name="ChargeStopDate" type="text" size="27" tabindex="26" /></td>
			</tr>
			<tr>
