...
<head>
	...
	<title>[ExecTranRecruitContinuance]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>リクルートかんたん支払い継続課金決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
