...
<div id="header">
	<h1>クレジットカード決済登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">本人認証サービス
利用フラグ(TdFlag)</th>
				<td><input name="TdFlag" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="Method" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">支払回数(PayTimes)</th>
				<td><input name="PayTimes" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">磁気ストライプ区分(MagstripeType)</th>
				<td><input name="MagstripeType" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">磁気ストライプ(MagstripeData)</th>
				<td><input name="MagstripeData" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目1(ClientField1)</th>
				<td><input name="ClientField1" type="text" size="27" tabindex="26" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目2(ClientField2)</th>
				<td><input name="ClientField2" type="text" size="27" tabindex="27" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目3(ClientField3)</th>
				<td><input name="ClientField3" type="text" size="27" tabindex="28" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店自由項目返却フラグ(ClientFieldFlag)</th>
				<td><input name="ClientFieldFlag" type="text" size="27" tabindex="29" /></td>
			</tr>
