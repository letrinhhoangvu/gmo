...
<head>
	...
	<title>[RegisterRecurringAccounttrans]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>自動売上自動売上登録(口座振替)/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="ChargeMonth" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">課金開始日(ChargeStartDate)</th>
				<td><input name="ChargeStartDate" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">課金停止日(ChargeStopDate)</th>
				<td><input name="ChargeStopDate" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目1(ClientField1)</th>
				<td><input name="ClientField1" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目2(ClientField2)</th>
				<td><input name="ClientField2" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目3(ClientField3)</th>
				<td><input name="ClientField3" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">通帳記載内容(PrintStr)</th>
				<td><input name="PrintStr" type="text" size="27" tabindex="25" /></td>
			</tr>
