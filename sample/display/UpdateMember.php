...
<head>
	...
	<title>[UpdateMember]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>会員更新/モジュールタイプ(PHP) 呼び出しサンプル</h1>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><input name="MemberName" type="text" size="30" maxlength="50" tabindex="12" /></td>
					</tr>
				</tbody>
			</table>
		</form>
