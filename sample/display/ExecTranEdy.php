...
<div id="header">
	<h1>モバイルEdy決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td><input name="EdyAddInfo1" type="text" maxlength="180" class="text"  tabindex="17" /></td>
				</tr>
				<tr>
					<th scope="row">決済終了メール付加情報</th>
					<td><input name="EdyAddInfo2" type="text" maxlength="320" class="text"  tabindex="18" /></td>
				</tr>
				<tr>
