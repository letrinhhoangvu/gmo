...
<head>
	...
	<title>[AlterTranMagstripe]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>クレジットカード決済決済変更/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="JobCd" type="text" size="27" tabindex="15" /></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">利用日(YYMMDD)(DisplayDate)</th>
				<td><input name="DisplayDate" type="text" size="27" tabindex="17" /></td>
			</tr>
