...
<head>
	...
	<title>[DocomoContinuanceStart]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ継続課金支払手続き開始/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="DocomoContinuanceStartURL" type="text" size="27" tabindex="11" /></td>
			</tr>
			<tr>
