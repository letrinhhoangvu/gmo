...
<div id="header">
	<h1>リクルートかんたん支払い継続課金登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="ClientFieldFlag" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="ChargeDay" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">初月無料フラグ(FirstMonthFreeFlag)</th>
				<td><input name="FirstMonthFreeFlag" type="text" size="27" tabindex="26" /></td>
			</tr>
